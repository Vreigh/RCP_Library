...
public class AuthorEditingSupport extends TitleEditingSupport{
    ...
    protected void setValue(Object element, Object userInputValue) {
    	...
    	Optional<String> error = DataProvider.INSTANCE.updateBook(book.getId(), null, null, null, null, input, null, null, null, null);
    	
    	if(!error.isPresent()) {
    		book.update(null, null, null, null, input, null, null, null, null);
